package genericdwh.gui.subwindows.connect;
...
public class ConnectWindowController {
	...
	public void createWindow() {
		try {
			SpringFXMLLoader loader = new SpringFXMLLoader(getClass().getResource("/fxml/subwindows/ConnectWindow.fxml"), Main.getContext().getBean(ConnectWindowController.class));
