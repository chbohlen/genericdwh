package genericdwh.gui.subwindows.connectwindow;
...
public class ConnectWindowController {
	...
	public void createWindow() {
		try {
			SpringFXMLLoader loader = new SpringFXMLLoader(getClass().getResource("/fxml/subwindows/connectwindow/ConnectWindow.fxml"), Main.getContext().getBean(ConnectWindowController.class));
