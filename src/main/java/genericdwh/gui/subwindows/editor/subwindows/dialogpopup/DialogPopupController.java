...
public abstract class DialogPopupController {
	...
	public void createWindow(String title, Class<?> controllerClass, Image icon) {
		try {
			SpringFXMLLoader loader = new SpringFXMLLoader(getClass().getResource("/fxml/subwindows/editor/subwindows/PopupDialog.fxml"), Main.getContext().getBean(controllerClass));
